/*
========================================================================================
    SUBWORKFLOW: TT-seq debugging workflow with FASTQ subsetting
========================================================================================
*/
...
/*
========================================================================================
    SUBWORKFLOW: TT-seq debugging analysis workflow
========================================================================================
*/

workflow TTSEQ_DEBUG {
    ...
    //
    // MODULE: Subset FASTQ files for debugging
    //
    SUBSET_FASTQ (
        ch_reads
    )
    ch_versions = ch_versions.mix(SUBSET_FASTQ.out.versions.first())

    //
    // Use subset reads for remaining workflow
    //
    ch_subset_reads = SUBSET_FASTQ.out.reads

    //
    // MODULE: Run FastQC on subset
    //
    ...
    subset_reads     = SUBSET_FASTQ.out.reads
